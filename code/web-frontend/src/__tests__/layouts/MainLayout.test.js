...
const MockHomePage = () => (
  <div data-testid="mock-home-page">Home Page Content</div>
);
const MockAboutPage = () => (
  <div data-testid="mock-about-page">About Page Content</div>
);

// Mock any components directly used by MainLayout, e.g., a Navbar or Footer
jest.mock("../../../components/Navbar", () => () => (
  <nav data-testid="mock-navbar">Mock Navbar</nav>
)); // Example if Navbar is a separate component
jest.mock("../../../components/Footer", () => () => (
  <footer data-testid="mock-footer">Mock Footer</footer>
)); // Example if Footer is a separate component
...
describe("MainLayout Component", () => {
  ...
  it("renders its children content", () => {
    ...
    expect(screen.getByTestId("child-paragraph")).toHaveTextContent(
