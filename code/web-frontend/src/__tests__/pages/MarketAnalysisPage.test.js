...
jest.mock('../../../components/MarketAnalysis', () => () => <div data-testid="mock-market-analysis-component">Mocked MarketAnalysis Component</div>);
...
describe('MarketAnalysis Page', () => {
    it('renders without crashing and displays the MarketAnalysis component', () => {
        ...
        expect(screen.getByTestId('mock-market-analysis-component')).toBeInTheDocument();
    });
