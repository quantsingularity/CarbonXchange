            ...
            <CardContent>
              ...
              <Box sx={{ height: 400 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart
                    data={
                      forecastResult.length > 0 ? forecastResult : forecastData
                    }
                ...
                <CardContent>
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    <Typography variant="body2" paragraph>
                      Current market conditions indicate a growing demand for
                      carbon credits, particularly in renewable energy sectors.
                      Supply constraints are expected to continue for the next
                      quarter, potentially driving prices upward.
                    </Typography>
                  </Box>
                  <Box sx={{ mb: 2 }}>
                    <Typography
                    ...
                    <Typography variant="body2" paragraph>
                      Recent policy changes in the EU and North America are
                      likely to increase corporate demand for carbon offsets.
                      New compliance requirements could create additional market
                      pressure by Q3 2025.
                    </Typography>
                  </Box>
                  <Box>
                    ...
                    <Typography variant="body2">
                      Based on AI forecasting models, the optimal strategy
                      suggests accumulating credits during the current price
                      stability period, before the anticipated rise in Q3-Q4
                      2025.
                    </Typography>
                  </Box>
                </CardContent>
