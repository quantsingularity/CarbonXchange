...
class Transaction(db.Model):
    ...
    credit_quantity = Column(Numeric(15, 4), nullable=True)
    ...
    def to_dict(self, include_sensitive: Any = False) -> Any:
        ...
        data = {
            ...
            "credit_quantity": (
                float(self.credit_quantity) if self.credit_quantity else None
            ),
...
class TransactionLog(db.Model):
    ...
    def to_dict(self) -> Any:
        ...
        return {
            ...
            "notes": self.notes,
            "field_changes": (
                json.loads(self.field_changes) if self.field_changes else None
            ),
            "created_at": self.created_at.isoformat(),
        }
            ...
            data.update(
                {
                    ...
                    "old_values": (
                        json.loads(self.old_values) if self.old_values else None
                    ),
                    "new_values": (
                        json.loads(self.new_values) if self.new_values else None
                    ),
                    "compliance_flags": (
                        json.loads(self.compliance_flags)
