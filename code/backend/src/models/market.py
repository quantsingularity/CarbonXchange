...
from sqlalchemy import Column, Integer, String, DateTime, Boolean, Text, Numeric, ForeignKey, Enum as SQLEnum, Index
...
class MarketData(db.Model):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'change_percentage_24h': float(self.change_percentage_24h) if self.change_percentage_24h else None,
...
class PriceHistory(db.Model):
    ...
    # Indexes for performance
    __table_args__ = (
        Index('idx_price_history_symbol_timeframe_period', 'symbol', 'timeframe', 'period_start'),
