...
from ..models.user import User, UserStatus, UserSession, UserAuditLog
...
class AuthService:
    ...
    def register_user(self, email: str, password: str, first_name: str, last_name: str, 
                     phone_number: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        """
    ...
    def reset_password_request(self, email: str) -> bool:
        ...
        try:
            ...
            self.audit_service.log_event(
                ...
                ip_address=self._get_client_ip(),
                success=True,
                metadata={'reset_token_hash': hashlib.sha256(reset_token.encode()).hexdigest()}
            )
