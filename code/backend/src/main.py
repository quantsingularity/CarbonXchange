...
from src.models.user import User, UserProfile, UserKYC
from src.models.carbon_credit import CarbonProject, CarbonCredit, CreditCertificate
from src.models.trading import Order, Trade, Portfolio, PortfolioHolding
from src.models.transaction import Transaction, TransactionLog, AuditLog
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('carbonxchange.log'),
